...
{
    public class InvoiceServiceLithuanian : IInvoiceService
    {

        private readonly IShipmentService _shipmentService;
        private readonly IConverter _converter;
        
        public InvoiceServiceLithuanian(IShipmentService shipmentService, IConverter converter)
        {
        ...
        private static string GetShipmentHtmlString(Shipment shipment, string trackingId)
        {
            ...
            sb.Append(@"
                        <html>
                            ...
                            <body>
                                <div class='header'><h1>Siunta</h1></div>
                                <table align='center'>
                                    <tr>
                                        <th>Sekimo numeris</th>
                                        <th>Gavėjas</th>
                                        <th>El. paštas</th>
                                        <th>Telefonas</th>
                                    </tr>");
        ...
        public async Task<byte[]> GenerateInvoice(Guid shipmentId)
        {
            ...
            var objectSettings = new ObjectSettings
            {
                ...
                HeaderSettings = { FontName = "Arial", FontSize = 9, Right = "Puslapis [page] iš [toPage]", Line = true },
                FooterSettings = { FontName = "Arial", FontSize = 9, Line = true, Center = "Poraštė" }
            };
